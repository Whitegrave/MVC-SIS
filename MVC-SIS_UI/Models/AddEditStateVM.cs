...
namespace MVC_SIS_UI.Models
{
    public class AddEditStateVM : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // Error if null
            if (currentState == null || currentState.StateName == "" || currentState.StateAbbreviation == null)
            {
            ...
            if (currentState.StateName.Length > 20 || currentState.StateAbbreviation.Length != 2)
            {
